...
const Item = ({phoneData , img}) => {
  return (
    ...
    <a href="#">
        <img class="p-8 rounded-t-lg" src={phoneData.picture} alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{phoneData.breed + ' ' + phoneData.name}</h5>
        </a>
        ...
        <div class="flex justify-between items-center">
            <span class="text-sm font-bold text-gray-900 dark:text-white">{phoneData.price}</span>
